...
describe('AppComponent', () => {
  ...
  it(`should have as title 'Books Management System'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.debugElement.componentInstance;
    expect(app.title).toEqual('Books Management System');
  });
  ...
  it('should render title in a <a> tag', () => {
    ...
    expect(compiled.querySelector('a').textContent).toContain('Books Management System');
  });
